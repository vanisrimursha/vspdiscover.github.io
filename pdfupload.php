...
echo "<script> window.open('pdfupload.html','_self')</script>";
}
...
$file = rand(1000,100000)."-".$_FILES['file']['name'];
 ...
 $sql="INSERT INTO pdf_file(author_name,course_type, course_name, file,type,size) VALUES('$author_name','$course_type','$course_name','$file','$file_type','$file_size')";
 mysql_query($sql); 
