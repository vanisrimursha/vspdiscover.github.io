...
var questions = [
                  [ "C++ Programming Language was developed by Bjarne Stroustrup in -----------  ?", "1989", "1979", "1969", "B" ],
	...
	[ "-------------- operators cannot be used with switch statement?", "Logical", "Bitwise", "Conditional", "A" ],
                  [ "There are  ------ types of loop control statements in C++ language.?", "5", "2", "3", "C" ],
	...
	[ "---------- Open for reading in binary mode in C++?", "wb", "rb", "ab", "B" ],
[ "----------------  Open for append. i.e, Data is added to end of file in C++?", "r", "a", "r+", "B" ],
[ "------------  Open for both reading and appending in binary modein C++?", "a+", "ab+", "wb+", "B" ]
];
function _(x){
